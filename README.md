...
- `cwf.agda`: arranging all the pieces in a category with families. The resulting CwF supports Pi types (with η), positive Σ types (without η), natural numbers with large elimination
